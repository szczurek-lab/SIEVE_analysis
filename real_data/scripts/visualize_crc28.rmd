...
SIEVE_PREFIX <- "../crc28/improved"
ALT_PREFIX <- "../crc28/all_methods"
...
CELLPHY_TREE <- paste(ALT_PREFIX, "cellphy", "crc28.raxml.bestTree.nexus", sep = "/")
SCIPHI_TREE <- paste(ALT_PREFIX, "sciphi", "crc28", "best_index", "tree.nexus", sep = "/")
